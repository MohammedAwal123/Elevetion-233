...
<head>
    ...
    <title>Elevation 233 Photography</title>
    ...
    <body>
        ...
        <div class="cd-bg-video-wrapper" data-image="img/bangkok-city1">
            <!-- video element will be loaded using jQuery -->
        </div><!-- .cd-bg-video-wrapper --> 
        <div class="cd-bg-video-wrapper" data-image="img/bangkok-city">
            <!-- video element will be loaded using jQuery -->
        </div><!-- .cd-bg-video-wrapper -->
        ...
        <div class="cd-hero">
                ...
                <div class="container-fluid black-bg" >
                    <nav class="navbar black-bg">
                        <div class="tm-navbar-bg">                            
                            <img src="img/el1.jpg" style="width: 300px; position: relative; top: 0%; left: 0%;">
                                    ...
                                    <div class="tm-home-container-outer">
                                        <div class="tm-home-container">
                                            <div class="tm-home-title-container">
                                                <h2 class="tm-text-title text-xs-center tm-home-title">Welcome to Elevation 233 Photography!</h2>    
                                            </div>
                                            <div class="tm-home-description-container tm-bg-dark-blue">
                                                <div class="text-xs-left tm-textbox">                                            
                                                    <p class="tm-text tm-home-description">Elevation 233; World of Photography and Arts Aesthetical Creativity</p>
                                    ...
                                    <div class="tm-flex">
                                        <div class="col-lg-6 tm-white-header-container-outer tm-margin-b tm-2-col-left">
                                            <div class="tm-bg-white tm-white-header-container">
                                                <h2 class="tm-text-title tm-text-title-small">Elevation233</h2>
                                            </div>
                                            <div class="tm-bg-dark-blue text-xs-left tm-textbox tm-textbox-padding tm-white-header-body tm-white-border tm-2-col-equal-height">
                                                <p class="tm-text">Elevation233 is a Ghanaian owened company specialized in Photography & Arts Aesthetical Creativity, and it has been providing beautiful photographs and Arts aesthetical creativity services since its establishment  Nulla scelerisque vitae augue non viverra. Mauris nibh eros, gravida id rutrum eu, placerat quis enim. Ut massa mi, convallis eget pharetra eget, laoreet sit amet orci. Sed tincidunt nisi ut lectus pellentesque viverra. Aliquam condimentum lacinia.</p>                                            
                                            </div>    
                                        </div>
                                    ...
                                    <div class="tm-img-gallery-container">
                                        ...
                                        <!-- Gallery Two pop up connected with JS code below -->
                                            ...
                                            <div class="tm-gallery-title-container">
                                                <div class=" tm-white-border tm-textbox-padding tm-margin-b brown-bg">                                    
                                                    <h2 class="tm-text-title tm-gallery-title tm-margin-b-0 brown"><span class=" brown">Gallery</span></h2>                                        
                                                </div>
                                                <div class="tm-bg-white-half"></div>
                                            </div>

                                            <div class="grid-item">
                                                <a href="img2/el30.jpg">                                                
                                                    <img src="img2/el30.jpg" alt="Image" class="img-fluid tm-img">                                              
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/240.jpg">                                                
                                                    <img src="img2/240.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/233.jpg">                                                
                                                    <img src="img2/233.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/235.jpg">                                                
                                                    <img src="img2/235.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/el35.jpg">                                                
                                                    <img src="img2/el35.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/E-115.jpg">                                                
                                                    <img src="img2/E-115.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>

                                             <div class="grid-item">
                                                <a href="img2/9.jpg">                                                
                                                    <img src="img2/9.jpg" alt="Image" class="img-fluid tm-img"  style="height: 435px;">                                              
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/E-29.jpg">                                                
                                                    <img src="img2/E-29.jpg" alt="Image" class="img-fluid tm-img" style="height: 435px;">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/1a.jpg">                                                
                                                    <img src="img2/1a.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/8.jpg">                                                
                                                    <img src="img2/8.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/5.jpg">                                                
                                                    <img src="img2/5.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/2.jpg">                                                
                                                    <img src="img2/2.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/237.jpg">                                                
                                                    <img src="img2/237.jpg" alt="Image" class="img-fluid tm-img"  style="height: 355px;">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/241.jpg">                                                
                                                    <img src="img2/241.jpg" alt="Image" class="img-fluid tm-img">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item">
                                                <a href="img2/4.jpg">                                                
                                                    <img src="img2/4.jpg" alt="Image" class="img-fluid tm-img" style="height: 355px;">                                                
                                                </a>
                                            </div>                                                                               
                                        </div>                                         
                                        ...
                                        <div class="tm-img-gallery gallery-second">
                                         Gallery Two pop up connected with JS code below 
                                            ...
                                            <div class="grid-item grid-item-big">
                                                <a href="img2/237.jpg">                                                
                                                    <img src="img2/237.jpg" alt="Image" class="img-fluid tm-img-no-border">                                              
                                                </a>
                                            </div>
                                            <div class="grid-item grid-item-big">
                                                <a href="img2/E-29.jpg">                                                
                                                    <img src="img2/E-29.jpg" alt="Image" class="img-fluid tm-img-no-border" style="height: 600px;">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item grid-item-square">
                                                <a href="img2/1a.jpg">                                                
                                                    <img src="img2/1a.jpg" alt="Image" class="img-fluid tm-img-no-border"  style="height: 600px;">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item grid-item-square">
                                                <a href="img2/el11.jpg">                                                
                                                    <img src="img2/el11.jpg" alt="Image" class="img-fluid tm-img-no-border">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item grid-item-square">
                                                <a href="img2/el12.jpg">                                                
                                                    <img src="img2/el12.jpg" alt="Image" class="img-fluid tm-img-no-border">                                                
                                                </a>
                                            </div>
                                            <div class="grid-item grid-item-square">
                                                <a href="img2/el4.jpg">                                                
                                                    <img src="img2/el4.jpg" alt="Image" class="img-fluid tm-img-no-border">                                                
                                                </a>
                                            </div>                                                                            
                                        </div>                                         
                                    </div> .tm-img-gallery-container                                  
                    ...
                    <div class="cd-full-width">
                        <div class="container js-tm-page-content tm-section-margin-t-small" data-page-no="4">                            
                            <div class="tm-contact-page">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="tm-flex tm-contact-container black-bg">                                
                                            <div class="text-xs-left tm-textbox tm-2-col-textbox-2 tm-textbox-padding tm-textbox-padding-contact">
                                                <p class="tm-text">Get intouch for your : Weddings, Parties, Graduations, Events, Conferences, Portraits and Cultural photos.</p>                                                                                                                                                 
                                                <p class="tm-text">Elevation233 Photography & Arts Aesthetical Creativity<br>MadMan.MadVision@diaries_of_a_madman<br>Elevation233@yahoo.com<br>Elevation233@gmail.com<br>
                                                Tel: 0244120701 <br>Fax: 000-000-0000</p>
                                                <div>
                                                	<a href="https://www.instagram.com/elevation233/" style="margin-left:30px;"><img src="img2/instagram.png" style="width: 7%;" class="focus"></a>
                                                	<a href="https://web.facebook.com/jerry.kumessy" style="margin-left:50px;"><img src="img2/facebook.png" style="width: 6.7%;" class="focus"></a>
                                                </div>
                                            </div>

                                            <div class="text-xs-left tm-textbox tm-2-col-textbox-2 tm-textbox-padding tm-textbox-padding-contact">
                                                <!-- contact form -->
                                                <form action="func.php" method="post" class="tm-contact-form">
            ...
            <footer class="tm-footer">            
                <p class="tm-copyright-text pull-xs-right">Copyright &copy; <span class="tm-current-yar">2019</span> Mohammed Awal Umar            
                | Design: MAU CODES</p>
            </footer>                    
        </div> <!-- .cd-hero -->        
